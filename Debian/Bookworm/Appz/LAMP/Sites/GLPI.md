...
winget install glpi-agent --custom="SERVER=http://192.168.0.239 RUNNOW=1"
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\GLPI-Agent" /v server /t reg_dword /d "http://192.168.0.239" /f
```
...
###### Décalage Horaire
![image](https://github.com/Drthrax74/Linux/assets/35907/16bd7b02-18fb-467f-83eb-d702571c1e2b)

<br />

###### Flocon de noel, halloween ..
Au dessus de la balise `<?php`

```bash
nano /var/www/html/glpi/index.php;
nano /var/www/html/glpi/front/central.php;
```
...
# Citrouilles:
<script type="text/javascript" src="https://click123.ca/dist/js/pumpkin.js"></script>

# Fantômes: 
<script type="text/javascript" src="https://click123.ca/dist/js/ghost.js"></script>

# Chauve-Souris
<script type="text/javascript" src="https://click123.ca/dist/js/bat.js"></script>
```
